...
Abel Brodeur, Derek Mikola, Nikolai Cook et al. (inc. [Edmund Kelly]{.underline}). "Mass reproducibility and replicability: A new hope" (under review). <a style="color: #2780e3; text-decoration: underline; cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#abstract2" aria-expanded="false" aria-controls="abstract2"> \[Abstract\].</a> [\[Paper\]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4790780).<br> <br>
...
Abel Brodeur, David Valenta, Alexandru Marcoci et al. (inc. [Edmund Kelly]{.underline}). "Comparing Human-Only, AI-Assisted, and AI-Led Teams on Assessing Research Reproducibility in Quantitative Social Science" (under review). <a style="color: #2780e3; text-decoration: underline; cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#abstract5" aria-expanded="false" aria-controls="abstract5"> \[Abstract\].</a> [\[Paper\]](https://econpapers.repec.org/paper/zbwi4rdps/195.htm). <br> <br>d
